...
ollama create llama-generalist-enh:latest -f rag_pipeline/roles-enhanced/modelfiles-enh/generalist-midlevel.md
...
VARIANTS_PATH = SCRIPT_DIR / "variants-few-new-enh.yaml"
